module.exports = function(grunt) {
  ...
  grunt.initConfig({
	...
	concat: {
		...
		dist: {
			src: ['assets/js/material.min.js', 'assets/js/dialog-polyfill.js', 'assets/js/dragula.min.js', 'assets/js/sanitizer.js', 'assets/lib/config.js', 'assets/lib/log.js', 'assets/lib/user.js', 'assets/lib/firebase.js', 'assets/lib/utils.js', 'assets/lib/init.js'],
